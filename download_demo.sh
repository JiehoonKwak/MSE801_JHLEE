...
download_if_not_exists "$GITHUB_RAW_URL/subsampled_SRR7138439_WES_of_homo_sapiens_tumor_of_brain_tumor_patient_1.fastq.gz" "$TARGET_DIR/subsampled_SRR7138439_WES_of_homo_sapiens_tumor_of_brain_tumor_patient_1.fastq.gz"
download_if_not_exists "$GITHUB_RAW_URL/subsampled_SRR7138439_WES_of_homo_sapiens_tumor_of_brain_tumor_patient_2.fastq.gz" "$TARGET_DIR/subsampled_SRR7138439_WES_of_homo_sapiens_tumor_of_brain_tumor_patient_2.fastq.gz"
