...
download_if_not_exists "$GITHUB_RAW_URL/subsampled_SRR7138440_WES_of_homo_sapiens_blood_of_brain_tumor_patient_1.fastq.gz" "$RAW_DIR/subsampled_SRR7138440_WES_of_homo_sapiens_blood_of_brain_tumor_patient_1.fastq.gz"
download_if_not_exists "$GITHUB_RAW_URL/subsampled_SRR7138440_WES_of_homo_sapiens_blood_of_brain_tumor_patient_2.fastq.gz" "$RAW_DIR/subsampled_SRR7138440_WES_of_homo_sapiens_blood_of_brain_tumor_patient_2.fastq.gz"
download_if_not_exists "$GITHUB_RAW_URL/subsampled_SRR7138439_WES_of_homo_sapiens_tumor_of_brain_tumor_patient_1.fastq.gz" "$RAW_DIR/subsampled_SRR7138439_WES_of_homo_sapiens_tumor_of_brain_tumor_patient_1.fastq.gz"
download_if_not_exists "$GITHUB_RAW_URL/subsampled_SRR7138439_WES_of_homo_sapiens_tumor_of_brain_tumor_patient_2.fastq.gz" "$RAW_DIR/subsampled_SRR7138439_WES_of_homo_sapiens_tumor_of_brain_tumor_patient_2.fastq.gz"
download_if_not_exists "$GITHUB_RAW_URL/subsampled_SRR7138438_WES_of_homo_sapiens_subventricular_zone_of_brain_tumor_patient_1.fastq.gz" "$RAW_DIR/subsampled_SRR7138438_WES_of_homo_sapiens_subventricular_zone_of_brain_tumor_patient_1.fastq.gz"
download_if_not_exists "$GITHUB_RAW_URL/subsampled_SRR7138438_WES_of_homo_sapiens_subventricular_zone_of_brain_tumor_patient_2.fastq.gz" "$RAW_DIR/subsampled_SRR7138438_WES_of_homo_sapiens_subventricular_zone_of_brain_tumor_patient_2.fastq.gz"
...
echo "All files have been downloaded to $TARGET_DIR and $RAW_DIR"