...
- Original paper : [Human glioblastoma arises from subventricular zone cells with low-level driver mutations](https://www.nature.com/articles/s41586-018-0389-3)
    - SRA ID : SRP145073
- `SRA explorer` : [Link](https://sra-explorer.info/) : 37, 38, 40
```bash
curl -L ftp://ftp.sra.ebi.ac.uk/vol1/fastq/SRR713/007/SRR7138437/SRR7138437_1.fastq.gz -o SRR7138437_WES_of_homo_sapiens_brain_of_brain_tumor_patient_1.fastq.gz
curl -L ftp://ftp.sra.ebi.ac.uk/vol1/fastq/SRR713/007/SRR7138437/SRR7138437_2.fastq.gz -o SRR7138437_WES_of_homo_sapiens_brain_of_brain_tumor_patient_2.fastq.gz
